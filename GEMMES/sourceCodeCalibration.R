generateModelFile<-function(modelFile,exogText,initialValues,dataParameters,time,sampleText=NULL){
	...
	if(!is.null(sampleText))
		modelCode <- sub("@ADDSAMPLE", sampleText, modelCode)
